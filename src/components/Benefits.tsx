    ...
    <div className="w-full bg-black py-16 px-4 text-white">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-4xl font-bold text-center mb-12">
          Principais <span className="text-[#f8c304]">Benefícios</span> do Método
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Mobilidade Card */}
          <div className="bg-gradient-to-b from-[#0c1a2a] to-[#103259] rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-[#f8c304]/20">
            <div className="h-3 bg-gradient-to-r from-[#f8c304] to-[#ffd700]"></div>
            <div className="p-6 flex flex-col items-center">
              <div className="w-24 h-24 rounded-full bg-black/50 flex items-center justify-center mb-6 border-2 border-[#f8c304]/30">
